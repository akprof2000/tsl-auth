        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserName = table.Column<string>(type: "TEXT", maxLength: 1024, nullable: true),
                    ...
                    ConcurrencyStamp = table.Column<string>(type: "TEXT", nullable: true),
                    PhoneNumber = table.Column<string>(type: "TEXT", maxLength: 1024, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AccessRoleAssignments", x => new { x.RoleId, x.SubjectType, x.SubjectId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AccessRolePermissions", x => new { x.RoleId, x.PermissionId });
                    table.ForeignKey(
                        name: "FK_AccessRolePermissions_AccessPermissions_PermissionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AccessPermissions_ClientId_Name",
                table: "AccessPermissions",
                columns: new[] { "ClientId", "Name" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_AccessRoleAssignments_SubjectType_SubjectId",
                table: "AccessRoleAssignments",
                columns: new[] { "SubjectType", "SubjectId" });

            migrationBuilder.CreateIndex(
                name: "IX_AccessRolePermissions_PermissionId",
                table: "AccessRolePermissions",
                column: "PermissionId");

            migrationBuilder.CreateIndex(
                name: "IX_AccessRoles_ClientId_Name",
                table: "AccessRoles",
                columns: new[] { "ClientId", "Name" },
                unique: true);
