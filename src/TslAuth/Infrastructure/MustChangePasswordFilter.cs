...
/// <summary>
/// Пока временный пароль не сменён, админка и личный кабинет недоступны — перенаправляем на смену пароля.
/// Навешивается на папку /Admin и страницы /Account (кроме входа, выхода и самой смены пароля) в ServiceSetup; флаг читается из БД на каждый запрос (не из cookie),
